...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const progressInterval = setInterval(() => {
      setProgress((prev) => {
        ...
        return prev + (100 / SLIDE_DURATION) * 100; // Atualiza a cada 100ms
      });
    }, 100);
  ...
  return (
// O py-10 e md:py-20 gerenciam a margem superior e inferior
<section
  id="hero"
...
>
      {/* Fundo com Figuras Geométricas Melhorado */}
  ...
  <svg
        ...
        >
          {/* Padrão de ondas suave */}
          <motion.defs>
            <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              {/* Ajustei as cores para serem mais visíveis */}
          ...
          {/* Círculos decorativos - Verde e Azul */}
      ...
      <div className="relative w-full max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-center px-4 md:px-8 gap-10 md:gap-4">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left">
          ...
          {/* Botões de Ação - Centralizado em Mobile, Alinhado à Esquerda em Desktop */}
...
<Link
      ...
      className="inline-flex items-center justify-center gap-2 text-white 
                 ...
                 max-w-xs   sm:w-auto mx-auto md:mx-0" // mx-auto para centralizar e max-w-xs para limitar a largura
    >
      Anuncie Agora
      <ExternalLink size={20} />
        ...
        {/* Lado Direito - Imagem e Controles */}
        <div className="relative w-full md:w-1/2 flex items-center justify-center p-6">
          ...
          {/* Ajustado: -bottom-12 para descer mais e evitar o texto */}
          <div className="absolute -bottom-0 left-1/2 transform -translate-x-1/2 flex items-center space-x-2 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
            ...
            {/* Indicadores de Pontinhos (Dots) - Mantidos para navegação */}
