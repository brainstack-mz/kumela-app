        ...
        <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop
                offset="0%"
                style={{ stopColor: "#A4C639", stopOpacity: 1 }}
              />
              <stop
                offset="100%"
                style={{ stopColor: "#8BC34A", stopOpacity: 1 }}
              />
            </linearGradient>
            <linearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop
                offset="0%"
                style={{ stopColor: "#CDDC39", stopOpacity: 1 }}
              />
              <stop
                offset="100%"
                style={{ stopColor: "#9CCC65", stopOpacity: 1 }}
              />
            </linearGradient>
          </defs>
          <circle
          ...
          <polygon
            ...
            className="rotate-45 animate-spin-slow"
            fill="url(#gradient2)"
            style={{ transformOrigin: "50% 50%" }}
          />
          <path
            d="M 80 50 C 95 60, 85 70, 70 70 C 55 70, 65 60, 80 50 Z"
          ...
          />
          <path
            d="M 30 70 Q 50 90, 70 70 L 70 80 Q 50 100, 30 80 L 30 70 Z"
            fill="url(#gradient1)"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 font-light text-sm sm:text-base text-justify">
              ...
              Juntos, transformamos o campo em um lugar melhor para todos.
            </p>
          </div>
