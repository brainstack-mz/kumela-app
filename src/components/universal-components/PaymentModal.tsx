...
import Step1CustomerForm from "@/components/products/Step1CustomerForm";
import Step2PaymentForm from "@/components/products/Step2PaymentForm";
...
const carriers = ["Transmarítima", "Caminhos de Ferro", "Expresso Moz"];
