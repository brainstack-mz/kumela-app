...
import { User, Phone, Key, MapPin, ArrowLeft, Briefcase, ShoppingBag, Truck } from 'lucide-react';
...
const provincesData = {
  ...
  // Adicione outras províncias e distritos conforme necessário
};
  ...
  return (
    <form onSubmit={handleRegister} className="space-y-4">
      ...
      <div className="relative">
        <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2" size={20} color={colors.iconBlue} />
        <select
          required
          value={accountType}
